...
<form action="custom-login" method="post" >
    @csrf
<div class="container flex flex-col justify-center items-center md:w-1/2 lg:w-1/3 m-auto">
<div class="container border border-solid border-black  bg-yellow-400 p-4 shadow-md rounded-md text-left" style="max-width: 400px">
    ...
    <div id="whoobe-h90kl" class="w-full p-2 justify-start flex flex-col">
        <div id="whoobe-7izhv" class=" flex flex-row">
            <span id="whoobe-plfl9" class="z-highest rounded-l-lg w-10 h-10 flex justify-center items-center text-2xl text-gray-400 border border-r-0" mode="render" block="">
            ...
            <input class="border border-gray-200 rounded-r-lg outline-none focus:ring-1 ring-blue-400 w-full pl-1" name="email" placeholder="email" required>
        </div>
        
        <div id="whoobe-l6k6r" class="my-4 flex flex-row">
            <span id="whoobe-4occ6" class="z-highest rounded-l-lg w-10 h-10 flex justify-center items-center text-2xl text-gray-400 border border-r-0" mode="render" block="">
            ...
            <input type="password" value="" class="h-10 border border-gray-200 rounded-r-lg outline-none focus:ring-1 ring-blue-300 w-full pl-1" name="password" placeholder="password" required="false">
        </div>
        <button value="button" class="px-4 py-2 rounded bg-blue-400 text-white hover:bg-blue-700 my-4 w-full" id="whoobe-ibemp">Login</button>
    </div>
  </div>
</div>
@endsection